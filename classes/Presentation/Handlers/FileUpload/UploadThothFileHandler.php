...
class UploadThothFileHandler extends Handler
{
    ...
    public function __construct(
        ...
        private readonly PublicationFileFormReader $formReader,
        private readonly TemporaryUploadReceiver $temporaryUploads,
        private readonly CatalogPublicationFilesProvider $catalogFiles,
        private readonly UploadPublicationFile $uploadPublicationFile,
