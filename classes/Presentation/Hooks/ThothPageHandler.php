...
final class ThothPageHandler
{
    ...
    public function __construct(
        ...
        private readonly ThothCatalogFilesHandler $catalogFilesHandler,
        private readonly UploadThothFileHandler $uploadHandler,
        private readonly ThothHandler $indexHandler
    ) {
    }
