...
final class HookRegistrant
{
    public function __construct(
        ...
        private readonly ThothSchema $schema,
        private readonly PublishFormConfig $publishForm,
        private readonly CatalogEntryFormConfig $catalogEntryForm,
        private readonly ContributorFormConfig $contributorForm,
        private readonly PublicationFormatFormHandler $publicationFormatForm,
        private readonly PublicationPublishListener $publicationPublishListener,
        private readonly PublicationEditListener $publicationEditListener,
        private readonly ThothEndpoint $endpoint,
        private readonly ThothCatalogFilesTemplateFilter $catalogFilesFilter,
        private readonly ThothFrontcoverTemplateFilter $frontcoverFilter,
        private readonly ThothFeatureVideoTemplateFilter $featureVideoFilter,
        private readonly ThothSectionTemplateFilter $sectionFilter,
        private readonly ThothNotification $notification,
        private readonly ThothMenuHandler $menuHandler,
        private readonly ThothPageHandler $pageHandler,
        private readonly PublicationFormatGridModifier $publicationFormatGrid,
        private readonly CatalogPublicationFilesProvider $catalogFiles,
    ...
    public function register(): void
    {
        ...
        Hook::add('APIHandler::endpoints::_submissions', $this->endpoint->addEndpoints(...));
