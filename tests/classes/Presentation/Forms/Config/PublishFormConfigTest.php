...
final class PublishFormConfigTest extends PKPTestCase
{
    ...
    private function submission(?string $workId, int $workType): object
    {
        return new class ($workId, $workType) {
            public function __construct(private readonly ?string $workId, private readonly int $workType)
            {
            }
...
{
    public function __construct(private readonly ?object $submission)
    {
    }
...
final class RegistrationMetadataValidatorDouble implements RegistrationMetadataValidator
{
    ...
    public function __construct(private readonly array $errors, private readonly ?\Throwable $failure = null)
    {
    }
...
{
    public function __construct(private readonly bool $canUploadFiles, private readonly array $imprints = [])
    {
    }
