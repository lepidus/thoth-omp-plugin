...
final class ThothSectionTemplateFilterTest extends PKPTestCase
{
    public function testProvidesWorkflowUrlsThroughInlineJavaScriptData(): void
    {
        ...
        $this->assertStringContainsString('api/submissions/__submissionId__/featureVideo', $script);
        $this->assertStringContainsString(
            'api/submissions/__submissionId__/publications/__publicationId__/synchronize',
            $script
        );
        $this->assertStringContainsString('api/submissions/__submissionId__/thothWork', $script);
