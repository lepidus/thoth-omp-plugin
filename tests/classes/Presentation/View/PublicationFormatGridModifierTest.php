...
final class PublicationFormatGridModifierTest extends PKPTestCase
{
    ...
    {
        $handler = new PublicationFormatGridHandlerDouble([ROLE_ID_MANAGER]);
    ...
    {
        $handler = new PublicationFormatGridHandlerDouble([ROLE_ID_AUTHOR]);
        $templateManager = new PublicationFormatGridTemplateManagerDouble([
            'actions' => [new \stdClass(), new \stdClass()],
            'categoryRow' => new PublicationFormatCategoryRowDouble(),
        ]);
    ...
    {
        $handler = new PublicationFormatGridHandlerDouble([ROLE_ID_ASSISTANT]);
        $templateManager = new PublicationFormatGridTemplateManagerDouble();
        $modifier = new PublicationFormatGridModifier(new PublicationFormatGridRequestDouble($handler));
...
{
    private PublicationFormatGridHandler $handler;
    public function __construct(PublicationFormatGridHandler $handler)
    {
    ...
    public function getDispatcher(): object
    {
        return new class () {
            public function url(
                ...
                return 'https://example.test/' . ($route === ROUTE_PAGE ? 'page/' : 'api/')
