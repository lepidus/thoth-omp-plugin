...
namespace APP\plugins\generic\thoth\tests\classes\Infrastructure\Thoth\Configuration;
...
{
    public function testImplementsConfigurationVerifierPort(): void
    {
        $verifier = new ThothConfigurationVerifier(
            new ThothApiUrlGuard(fn (): array => ['93.184.216.34']),
            fn (): object => new VerifierClient()
        );

        $this->assertInstanceOf(ConfigurationVerifier::class, $verifier);
    }
