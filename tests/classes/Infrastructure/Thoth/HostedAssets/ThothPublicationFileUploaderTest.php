...
final class ThothPublicationFileUploaderTest extends TestCase
{
    public function testItReusesAnExistingBookPublicationBeforeUploading(): void
    {
        ...
        $client = new Pkp33PublicationUploadClient(true);
        $http = new Pkp33PublicationUploadHttpClient();
        $contextReader = new PkpPublicationFileContextReader(
            new Pkp33ChapterDaoMustNotBeCalled(),
            new Pkp33PublicationFormatDaoStub(new Pkp33PublicationFormatStub('DA', 'PDF', '978-1-4028-9462-6'))
        );
    ...
    public function testItResolvesAChapterCreatesItsRemotePublicationAndUploadsTheFile(): void
    {
        ...
        $client = new Pkp33PublicationUploadClient();
        $http = new Pkp33PublicationUploadHttpClient();
        $contextReader = new PkpPublicationFileContextReader(
            new Pkp33ChapterDaoStub(new Pkp33ChapterStub('10.1234/chapter one')),
            new Pkp33PublicationFormatDaoStub(new Pkp33PublicationFormatStub('DA', 'EPUB', '978-1-4028-9462-6'))
        );
        $guard = new ThothApiUrlGuard(fn (): array => ['93.184.216.34']);
        $uploader = new ThothPublicationFileUploader(
            new ThothRemoteGateway($client, new ThothErrorTranslator()),
...
final class Pkp33PublicationUploadClient
{
...
final class Pkp33PublicationUploadHttpClient
{
    public string $body = '';
...
final class Pkp33ChapterDaoStub
{
...
final class Pkp33ChapterDaoMustNotBeCalled
{
    public function getChapter(int $chapterId, int $publicationId): object
    {
...
final class Pkp33PublicationFormatDaoStub
{
...
final class Pkp33PublicationFormatStub
{
    ...
    public function __construct(string $entryKey, string $localizedName, string $isbn, ?string $remoteUrl = null)
    {
    ...
    {
        if ($name === 'name') {
            return ['en_US' => $this->localizedName];
        }

        return null;
    }

    public function getIdentificationCodes(): Pkp33IdentificationCodesStub
    {
        return new Pkp33IdentificationCodesStub([new Pkp33IdentificationCodeStub('15', $this->isbn)]);
    }
}

final class Pkp33IdentificationCodesStub
{
    private array $codes;
...
final class Pkp33IdentificationCodeStub
{
    private string $code;
