...
namespace APP\plugins\generic\thoth\tests\classes\fixtures;

use PKP\tests\PKPTestCase;

class MetadataMappingFixtureTest extends PKPTestCase
{
    public function testItCoversEveryPlannedMappingDomain(): void
    {
    ...
    public function testItDefinesNormalizedIdentifierContracts(): void
    {
        $fixture = $this->getFixture();
    ...
    public function testItDefinesForthcomingWorkAndOrderedCollectionContracts(): void
    {
        $fixture = $this->getFixture();
