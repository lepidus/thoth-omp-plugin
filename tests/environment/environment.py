...
def main():
    ...
    parser.add_argument("--dataset", type=Path, help="OMP stable-3_4_0 MySQL dataset (database.sql, files/, public/)")
...
def execute_cypress(run, entrypoint, *arguments, display=None, authority=None):
    ...
    # Cypress 12.17.2 forwards this single Chromium switch before its CLI arguments;
