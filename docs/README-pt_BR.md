...
[![Versão Atual](https://img.shields.io/github/v/release/thoth-pub/thoth-omp-plugin?filter=v0.3.%2A&sort=semver&label=vers%C3%A3o&color=blue)](https://github.com/thoth-pub/thoth-omp-plugin/releases)
...
- OMP 3.5.0-x [![Versão mais recente do plugin](https://img.shields.io/github/v/release/thoth-pub/thoth-omp-plugin?filter=v0.3.%2A&sort=semver&label=plugin&color=blue)](https://github.com/thoth-pub/thoth-omp-plugin/releases)
...
classificação usando um prefixo, como `THEMA:GTK` ou `BISAC:EDU000000`. As informações de classificação presentes
em metadados importados no OMP 3.5 também são reconhecidas automaticamente.
...
Execute os testes Cypress no [ambiente descartável OMP e Thoth](../tests/environment/README-pt_BR.md).
